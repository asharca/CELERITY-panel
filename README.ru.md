...
- **Диапазон портов (необязательно, например 20000-50000)** — UDP-порты для port hopping; оставьте пустым, чтобы отключить
...
| `PANEL_IP`           | ❌           | IPv4/IPv6-адреса хоста панели через запятую; используются для запрета несовместимого port hopping на том же VPS при другом имени хоста |
